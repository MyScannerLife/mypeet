	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="职业" prop="zhiye">
					<el-input v-model="ruleForm.zhiye" placeholder="职业" clearable  :readonly="ro.zhiye"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="职业" prop="zhiye">
					<el-input v-model="ruleForm.zhiye" placeholder="职业" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="select" v-if="type!='info'"  label="用户类型" prop="yonghuleixing">
					<el-select :disabled="ro.yonghuleixing" v-model="ruleForm.yonghuleixing" placeholder="请选择用户类型" >
						<el-option
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="用户类型" prop="yonghuleixing">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.yonghuleixingOptions = "正常用户,不可信用户".split(',')
