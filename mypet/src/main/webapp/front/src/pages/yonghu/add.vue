    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="职业" prop="zhiye">
            <el-input v-model="ruleForm.zhiye" 
                placeholder="职业" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="用户类型" prop="yonghuleixing">
            <el-select v-model="ruleForm.yonghuleixing" placeholder="请选择用户类型" disabled>
              <el-option
