  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}'   v-if="flag=='yonghu'"  label="电话号码" prop="dianhuahaoma">
          <el-input v-model="ruleForm.dianhuahaoma"               placeholder="电话号码" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}'   v-if="flag=='yonghu'"  label="职业" prop="zhiye">
          <el-input v-model="ruleForm.zhiye"               placeholder="职业" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-if="flag=='yonghu'"  label="用户类型" prop="yonghuleixing">
          <el-select v-model="ruleForm.yonghuleixing" :disabled="true" placeholder="请选择用户类型">
            <el-option
